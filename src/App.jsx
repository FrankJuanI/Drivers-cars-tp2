...
const TEAM_LOGOS = {
  Ferrari:
    "https://e7.pngegg.com/pngimages/202/123/png-clipart-ferrari-laferrari-car-ferrari-458-scuderia-ferrari-ferrari-logo-car.png",
  McLaren:
  ...
  "McLaren-Mercedes":
    "https://ih1.redbubble.net/image.2257949995.5265/st,small,507x507-pad,600x600,f8f8f8.jpg",
  "Red Bull":
    "https://cdn-7.motorsport.com/images/mgl/Y99JQRbY/s8/red-bull-racing-logo-1.jpg",
};
  ...
  return (
    <div className="App">
      {DRIVERS.map((driver, index) => {
        const countrieFlag = COUNTRIES[driver.nationality];
        const teamFlag = TEAM_LOGOS[driver.team];
        return (
          <Card
            key={DRIVERS.name}
            driver={driver}
            countrieFlag={countrieFlag}
            teamFlag={teamFlag}
            index={index}
          />
        );
